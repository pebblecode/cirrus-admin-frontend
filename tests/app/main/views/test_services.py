...
class TestServiceEdit(LoggedInApplicationTest):
    ...
    def test_service_edit_documents_post(self, data_api_client):
        ...
        data_api_client.update_service.assert_called_with('1', {
            'pricingDocumentURL': 'https://assets.test.cirrus.pebblecode.com/g-cloud-7/documents/2/1-pricing-document-2015-01-01-1200.pdf',  # noqa
            'sfiaRateDocumentURL': 'https://assets.test.cirrus.pebblecode.com/g-cloud-7/documents/2/1-sfia-rate-card-2015-01-01-1200.pdf',  # noqa
        }, 'test@example.com')
