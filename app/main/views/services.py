...
def view(service_id):
    ...
    content = content_loader.get_builder('inoket-1', 'edit_service_as_admin').filter(service_data)
...
def update(service_id, section_id):
    ...
    content = content_loader.get_builder('inoket-1', 'edit_service_as_admin').filter(service)
